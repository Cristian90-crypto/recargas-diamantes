...
* =====================================================
* MUY IMPORTANTE:
* Aquí NO llamamos a Shop2TopUp.
* El cliente todavía NO ha pagado.
* Primero generamos un número de solicitud local
* para identificar el pedido y lo enviamos por WhatsApp.
* Después tú verificas el pago.
* En el siguiente paso construiremos el panel
* donde tú podrás autorizar la recarga.
    */
...
try {
  ...
  const localRequestId =
    `RD-${Date.now().toString(36).toUpperCase()}`;
  ...
  lines.push(
    ...
    "",
    "Hola, quiero realizar esta recarga. Por favor, indícame cómo hacer el pago."
  );
  ...
  setMessage(
    "Solicitud preparada. WhatsApp se abrirá ahora."
  );
  setTimeout(() => {
      ...
      {showConfirmation && (
        <section className="confirmation">
          ...
          <div className="payment-warning">
            ...
            <p>
              Al continuar NO se realizará
              todavía la recarga.
            </p>
            <p>
              Primero recibirás las instrucciones
              de pago por WhatsApp.
            </p>
            <p>
              La recarga se realizará después
              de confirmar que el pago fue recibido.
            </p>
          </div>
          <button
            type="button"
          ...
          <p className="small-note">
            No se descuenta saldo de
            Shop2TopUp en este momento.
          </p>
        </section>
      )}
